...
from configurationJSON01 import ConfigurationJSON   # Tu reader JSON
from valid_config import valid_config_version_json  # Tu lógica de validación JSON

# --------------------------------------------------
# CONFIGURACIÓN
# --------------------------------------------------

FM_PATH = '../variability_model/policies_template/policy_structure03.uvl'

VALID_JSONS_DIR = '../../../resources/valid_jsons' # Carpeta con archivos filtrados como True
OUTPUT_CSV = './validation_results_valid_jsons.csv'
