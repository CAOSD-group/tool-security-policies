...
# Ejemplo de uso:
suma_total_files = 0
ruta_archivo = '../evaluation/validation_results_valid_jsons03_Z3.csv'  # Cambia esto por el nombre de tu archivo config_validation_results03_3_json10_FirstConfig
