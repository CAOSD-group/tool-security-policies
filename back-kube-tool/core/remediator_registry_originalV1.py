class RemediationRegistry:
    def __init__(self, uvl_path: str=None):
        ...
        self.registry = {
            ...
            # 1. Container Policies (Containers & InitContainers)
            # ==========================================
            ## io_k8s_api_batch_v1_CronJob_spec_jobTemplate_spec_template_spec_containers_securityContext_allowPrivilegeEscalation
            "kubernetes_no_self_privesc": [
                {"feature_to_fix": "DYNAMIC_CONTAINER_SUFFIX_securityContext_allowPrivilegeEscalation", "safe_value": False}
            ],
